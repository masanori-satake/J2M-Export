...
class Config:
    ...
    def load(self):
            ...
            try:
                with open(config_path, "r", encoding="utf-8") as f:
                    ...
                    if file_config:
                        ...
                        self.no_resume = bool(file_config.get("no_resume", self.no_resume))
        ...
        parser.add_argument("--no-resume", action="store_true", default=None, help="途中からの再開を行わず、最初から新規エクスポートを実行します")
        ...
        if cli_args.no_resume is not None: self.no_resume = cli_args.no_resume
